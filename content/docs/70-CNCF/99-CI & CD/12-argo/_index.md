...
| -------- | --------   | -------    |-------    |-------    |-------    |
|  [Argo Project](https://argoproj.github.io/)      |   | [Github](https://github.com/argoproj)  |  | |
...
| 4 | **Argo** | GitOps 持续交付·Application/Project·同步策略·多集群管理 | [Killercoda Argo](https://killercoda.com/argo) | [官网](https://argo-cd.readthedocs.io/) |
